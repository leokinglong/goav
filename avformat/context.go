...
func (s *Context) AvformatSetProbesize(probsize int) {
	s.probesize = C.long(probsize)
}

func (s *Context) AvformatSetAnalyzeDuration(max_analyze_duration int) {
	s.max_analyze_duration = C.long(max_analyze_duration)
}

func (s *Context) AvformatSetFpsProbesize(fps_probe_size int) {
	s.fps_probe_size = C.int(fps_probe_size)
}

func (s *Context) AvformatSetFlags(flags int) {
	s.flags = C.int(flags)
}
